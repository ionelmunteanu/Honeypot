...
-ifndef(FPBGENERALTXNOP_PB_H).
-define(FPBGENERALTXNOP_PB_H, true).
-record(fpbgeneraltxnop, {
    counterinc,
    counterdec,
    setupdate,
    counter,
...
-ifndef(FPBGENERALTXNLIST_PB_H).
-define(FPBGENERALTXNLIST_PB_H, true).
-record(fpbgeneraltxnlist, {
    op = []
}).
-endif.

-ifndef(FPBGENERALTXNREQ_PB_H).
-define(FPBGENERALTXNREQ_PB_H, true).
-record(fpbgeneraltxnreq, {
    clock,
    ops = []
}).
-endif.
